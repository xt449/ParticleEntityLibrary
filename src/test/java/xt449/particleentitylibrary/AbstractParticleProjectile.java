...
public abstract class AbstractParticleProjectile {
	...
	static final void register(Plugin plugin) {
		if(!registered) {
			// ConcurrentModificationException - Bukkit.getScheduler().scheduleSyncRepeatingTask(plugin, () -> activeProjectiles.forEach(xt449.particleentitylibrary.AbstractParticleProjectile::idle), 100, 1);
	...
	/*protected xt449.particleentitylibrary.AbstractParticleProjectile(ParticleData particleData, Location location, Vector velocity, float drag) {
		this(particleData);
		data.location = location;
		data.velocity = velocity;
		data.drag = drag;
	...
	/*protected xt449.particleentitylibrary.AbstractParticleProjectile(ParticleData particleData, Location location, float drag) {
		this(particleData);
		data.location = location;
		data.drag = drag;
	}*/
	...
	/*protected xt449.particleentitylibrary.AbstractParticleProjectile(ParticleData particleData, Vector velocity, float drag) {
		this(particleData);
		data.velocity = velocity;
		data.drag = drag;
	}*/
	...
	/*protected xt449.particleentitylibrary.AbstractParticleProjectile(ParticleData particleData, float drag) {
		this(particleData);
		data.drag = drag;
	}*/
